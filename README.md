# CSC1097 template repo

This is a template for CSC1097 projects.
...
The name of your project must be of the form `2027-csc1097-XXXXXXX`, where "`XXXXXXX`"
should be replaced with your usernames (e.g. `2027-csc1097-username1-username2`).
**Note** that the year should be set as appropriate to your year of study. For example, in the
2026/2027 academic year this would change to '2027-csc1097-username1-username2') etc. 
